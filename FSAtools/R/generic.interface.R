# Generic .fsa collection processing pipeline interface
generic.interface <- function() {
	
	# Version name
	verName <- paste("FSAtools", as.character(packageVersion("FSAtools")), sep=" ")
	...
	tcltk::tktitle(topLevel) <- "FSAtools processor"
